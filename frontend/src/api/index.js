...
export const api = {
  ...
  regroupNativeScenes: (id, sid) => http.post(`/projects/${id}/scenes/${sid}/native-regroup`, { confirm: true }),
  ...
  reviewNovelArc: (id, aid, status, notes = '') => http.patch(`/projects/${id}/novel/arcs/${aid}/review`, { status, notes }),
  createNovelArc: (id, data) => http.post(`/projects/${id}/novel/arcs`, data),
  updateNovelArc: (id, aid, data) => http.patch(`/projects/${id}/novel/arcs/${aid}`, data),
  deleteNovelArc: (id, aid) => http.delete(`/projects/${id}/novel/arcs/${aid}`),
  splitNovelArc: (id, aid, data) => http.post(`/projects/${id}/novel/arcs/${aid}/split`, data),
  mergeNovelArcs: (id, data) => http.post(`/projects/${id}/novel/arcs/merge`, data),
  reorderNovelArcs: (id, arcIds) => http.put(`/projects/${id}/novel/arcs/reorder`, { arc_ids: arcIds }),
  ...
  planningBatches: (id) => http.get(`/projects/${id}/planning-batches`),
  updatePlanningTarget: (id, totalEpisodes) => http.patch(`/projects/${id}/planning-target`, { total_episodes: totalEpisodes }),
  planningBatch: (id, bid) => http.get(`/projects/${id}/planning-batches/${bid}`),
  createPlanningBatch: (id, data) => http.post(`/projects/${id}/planning-batches`, data),
  generatePlanningBatch: (id, bid) => http.post(`/projects/${id}/planning-batches/${bid}/generate`, {}, { timeout: 300000 }),
  reviewPlanningBatch: (id, bid, action, notes = '') => http.post(`/projects/${id}/planning-batches/${bid}/review`, { action, notes }),
  batchSnapshot: (id, bid) => http.get(`/projects/${id}/planning-batches/${bid}/snapshot`),
  generateBatchSnapshot: (id, bid) => http.post(`/projects/${id}/planning-batches/${bid}/snapshot/generate`, {}, { timeout: 300000 }),
  saveBatchSnapshot: (id, bid, data) => http.put(`/projects/${id}/planning-batches/${bid}/snapshot`, data),
  reviewBatchSnapshot: (id, bid, approve, overrideReason = '') => http.post(`/projects/${id}/planning-batches/${bid}/snapshot/review`, { approve, override_reason: overrideReason }),
  storyClues: (id) => http.get(`/projects/${id}/story-clues`),
  transitionStoryClue: (id, cid, data) => http.post(`/projects/${id}/story-clues/${cid}/transition`, data),
