...
- [漫剧生成 Skill 详细使用手册](docs/漫剧生成Skill详细使用手册.md)：Skill 管理、实际入口、LumenX 导演工作流、小说改编 Skill、自定义 Skill 与故障排查。
- [漫剧工作台新手教程](docs/漫剧工作台新手教程.md)：从新建项目到生成成片的基础流程。
- [长篇小说改编漫剧实施方案](docs/长篇小说改编漫剧-详细实施方案.md)：章节分析、Story Bible 与分集改编架构。
