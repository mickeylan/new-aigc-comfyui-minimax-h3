...
func NewRouter(cfg *config.Config, svc *service.Service) *gin.Engine {
	...
	r.DELETE("/api/projects/:id/candidates/:cid", svc.HandleDeleteGenerationCandidate)
	...
	r.PATCH("/api/projects/:id/novel/arcs/:aid/review", svc.HandleReviewNovelArc)
	r.POST("/api/projects/:id/novel/arcs", svc.HandleCreateNovelArc)
	r.PATCH("/api/projects/:id/novel/arcs/:aid", svc.HandleUpdateNovelArc)
	r.DELETE("/api/projects/:id/novel/arcs/:aid", svc.HandleDeleteNovelArc)
	r.POST("/api/projects/:id/novel/arcs/:aid/split", svc.HandleSplitNovelArc)
	r.POST("/api/projects/:id/novel/arcs/merge", svc.HandleMergeNovelArcs)
	r.PUT("/api/projects/:id/novel/arcs/reorder", svc.HandleReorderNovelArcs)
	...
	r.GET("/api/projects/:id/planning-batches", svc.HandleListPlanningBatches)
	r.PATCH("/api/projects/:id/planning-target", svc.HandleUpdatePlanningTarget)
	r.POST("/api/projects/:id/planning-batches", svc.HandleCreatePlanningBatch)
	r.GET("/api/projects/:id/planning-batches/:bid", svc.HandleGetPlanningBatch)
	r.POST("/api/projects/:id/planning-batches/:bid/generate", svc.HandleGeneratePlanningBatch)
	r.POST("/api/projects/:id/planning-batches/:bid/review", svc.HandleReviewPlanningBatch)
	r.GET("/api/projects/:id/planning-batches/:bid/snapshot", svc.HandleGetBatchSnapshot)
	r.POST("/api/projects/:id/planning-batches/:bid/snapshot/generate", svc.HandleGenerateBatchSnapshot)
	r.PUT("/api/projects/:id/planning-batches/:bid/snapshot", svc.HandleSaveBatchSnapshot)
	r.POST("/api/projects/:id/planning-batches/:bid/snapshot/review", svc.HandleReviewBatchSnapshot)
	r.GET("/api/projects/:id/story-clues", svc.HandleListStoryClues)
	r.POST("/api/projects/:id/story-clues/:cid/transition", svc.HandleTransitionStoryClue)
	...
	r.GET("/api/projects/:id/scenes/:sid/shots/retime-preview", svc.HandlePreviewShotRetime)
	r.POST("/api/projects/:id/scenes/:sid/shots/retime", svc.HandleApplyShotRetime)
