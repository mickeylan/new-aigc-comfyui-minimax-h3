...
func (s *QwenImagePromptProgramService) List() []PromptProgram {
	return []PromptProgram{
		...
		{Code: QwenImage21EditProgram, Name: "Qwen-Image-2.1 多图编辑提示词", TargetModel: "qwen-image-2.1", TargetMode: "multi-image-edit", MaxReferences: 10, Description: "按有序 <imageN> 绑定每张参考图职责，明确修改项、身份来源、画布与保留项。"},
	}
}
